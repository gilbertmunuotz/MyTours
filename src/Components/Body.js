    ...
    return (
        <div className='body' id='body'>
            ...
            <div className="Welcome-Text">
                <h1 className='text-5xl text-center uppercase italic font-serif mt-3'>John Deere Adventures</h1>
            ...
            <div className="CEOMessage">
                <h2 className='text-3xl text-center font-bold font-serif mt-8 mb-4'>Message From CEO.</h2>
                <div className="grid grid-cols-2 mt-6 sm:block mx-14 md:gap-4 ml-12">
                    <div className="video mb-2">
                        <img src={CEO} alt="CEO pic" className='object-cover h-96 rounded-lg lg:ml-24' />
                    </div>
            ...
            <div className="cards">
                <h5 className='font-bold text-3xl text-center my-6 font-serif'>Tours & Safari</h5>
            ...
            <div className="Gallery2 mb-8">
                <div className="grid">
                    <div className="grid-cols-3 flex mx-14 sm:block gap-3">
            ...
            <div className="Testimonials">
                ...
                <section className="text-gray-600 body-font">
                    <div className="py-12 mx-auto sm:self-center">
